...
async function addObligation(obligation) {
  ...
  `, [
        ...
        obligation.ProjectPhase,
        obligation.Action_DueDate,
        obligation.Close_Out_Date,
        obligation.Status,
        obligation.Supporting_Information,
        obligation.General_Comments,
        obligation.Compliance_Comments,
        obligation.NonConformance_Comments,
        obligation.Evidence,
        obligation.PersonEmail,
        obligation.Recurring_Obligation,
        obligation.Recurring_Frequency,
        obligation.Recurring_Status,
        obligation.Recurring_Forcasted_Date,
        obligation.Inspection,
        obligation.Inspection_Frequency,
        obligation.Site_or_Desktop,
        obligation.New_Control_action_required,
